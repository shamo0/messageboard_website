<!-- page for only admin where admin can delete,edit insert new mesages -->
<html lang="en">
<?php
...
if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true) {
  echo "<div class= 'welcome'> <h1> Welcome to the Admins only messageboard, " . $_SESSION['username'] . "! </h1></div>";
}
else { //if session not active go to index.html
...
<!-- form for admin to enter messages -->
<div class="forms_div20">
  <h3> Enter your message: </h3>
<form name="messageboard" method="post" action="http://localhost:8080/part2/newMessage.php" onsubmit="messageEscape()">
    <label for="message">
      <div class= "inputText">
    <input type="text" required name="mess" placeholder="Hello There!" maxlength="60"> 
     </div>
    </label>
    <!-- hidden field for session  token passing -->
...
<?php
    //SQL query to get the values from the database. and build the messageboard.
            ...
            if ($_SESSION['username'] == 'admin')
              {
                ...
                echo "<br>";
                echo "<br>";
                echo "<a href=\"http://localhost:8080/part2/deleteMessage.php?id=".$row['messageId']. "\" >";
                echo "<button class= 'button1'>  DELETE </button>";
                echo "</a><br>";
              }
                echo "<a href=\"http://localhost:8080/part2/editMessage.php?id=".$row['messageId']. "\" >";
